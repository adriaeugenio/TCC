...
if p.geraTodoHistorico == 0:  
    ...
    v = jp.juntaPlanilhas('Tarifas Domésticas','TarifasDomésticasNovo',headerList) 
    v1 = jph.juntaPlanilhasHistorico('Tarifas Domésticas','TarifasDomésticasHistorico') 

else:

    #Juntas as Fontes de Dados
    v = jp.juntaPlanilhas('Tarifas Domésticas','TarifasDomésticasHistorico',headerList)  

#Renomeia o arquivo
os.rename('TarifasDomésticasHistorico.csv', 'TarifasDomésticasGeral.csv')